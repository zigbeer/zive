...
foundApis.read = function (clusters, cId, payload, callback) {
    var readFuncs = [];
...
foundApis.write = function (clusters, cId, payload, callback) {
    var writeFuncs = [];
...
foundApis.configReport = function (clusters, cId, payload, callback) {
    var cfgRptRsps = [];
...
foundApis.readReportConfig = function (clusters, cId, payload, callback) {
    var readCfgRptRsps = [];
...
foundApis.discover = function (clusters, cId, payload, callback) {
